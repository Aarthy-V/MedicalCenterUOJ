...
<body>
	...
	<aside>
		<ul>
			...
			<li>
				<a href="view_student.php">View all Student</a>
			</li>
			<li>
...
{
	$id=$_GET['id'];
	$sql="SELECT StudentID,NIC, FacultyName, BatchName,Stu_firstName,Stu_lastName,Gender,DOB,PhoneNum,PermanentAddress FROM student, batch, faculty WHERE batch.BatchID=student.BatchID && faculty.FacultyID=student.FacultyID && student.FacultyID='$id'" ;
...
<div class="content">
		<center>
		<h1>Sort by faculty</h1>
		<br><br>
		<form method="GET">
		<input type="text" name="id" placeholder="Insert Faculty ID:">
