...
{
	$id=$_GET['id'];
	$sql="SELECT StudentID,NIC, FacultyName, BatchName,Stu_firstName,Stu_lastName,Gender,DOB,PhoneNum,PermanentAddress FROM student, batch, faculty WHERE batch.BatchID=student.BatchID && faculty.FacultyID=student.FacultyID && student.BatchID='$id'" ;
...
<div class="content">
		...
		<br><br>
		<form method="GET">
		<input type="text" name="id" placeholder="Insert Batch ID:">
