...
{
	$id=$_GET['id'];
	$sql="SELECT StudentID, FacultyName, BatchName,Stu_firstName,Stu_lastName,Gender,DOB,PhoneNum,PermanentAddress FROM student, batch, faculty WHERE batch.BatchID=student.BatchID && faculty.FacultyID=student.FacultyID && StudentID='$id'" ;
...
<div class="content">
		<center>
		<h1>Update particular Student Details</h1>
		<br><br>
		<form method="GET">
		...
		<table border="1px">
			...
			<tr>
				...
				<td class="table_td">
					<?php 
					echo "<a href='update_student_1.php?StudentID={$info['StudentID']}' class='btn btn-primary'>Update</a>";
					?>
				</td>
			</tr>
			<?php
